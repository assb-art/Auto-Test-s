...
#Поскольку проверка действий пустого списка идет после проверки дейтсвий в заполненном, - очистим существующий список
        Когда открылось окно "Контур.Фокус*"
        И     я нажимаю на гиперссылку "НастройкиСписка1"
        ...
        И     в таблице "СписокИНН" я нажимаю на кнопку "Очистить"
        И     я нажимаю на кнопку с именем "СохранитьСписокИНН"
        И     я нажимаю на кнопку "Сохранить"
        Тогда открылось окно "Контур.Фокус"
        И     я нажимаю на кнопку "Да"
#        Тогда открылось окно "Настройка списка для проверки: Контур.Фокус"
#        И     Я закрываю окно "Настройка списка для проверки: Контур.Фокус"
        Тогда в таблице "ТаблицаКонтрагентов" количество строк "равно" 0
...
И проверяем нажатие Действия - Показать подробную информацию о компании
        И     я нажимаю на кнопку "Показать подробную информацию о компании"
        Тогда открылось окно "Контур.Фокус*"
И проверяем отсутствие открытия карточки в вэб
        И     я нажимаю на кнопку "Открыть страницу компании в*"
        Тогда открылось окно "Контур.Фокус*"
...
И проверяем нажатие Действия - Удалить из списка элемент
        И     я нажимаю на кнопку "Удалить из списка*"
        Тогда открылось окно "Контур.Фокус*"
